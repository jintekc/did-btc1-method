...
// private key:
const keypair = GeneralUtils.generateSchnorrKeyPair();
console.log('Creating BTC1 Key Id with keypair:', keypair);

const response = await DidBtc1.create({ pubKeyBytes: keypair.publicKey });
